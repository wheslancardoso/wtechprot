...
export default async function Home() {
    ...
    return (
        <div className="dark flex min-h-screen flex-col bg-slate-950 text-slate-50 selection:bg-primary selection:text-primary-foreground">
            ...
            {/* Google Tag Manager - REMOVED TO AVOID CONVERSION TRACKING HERE */}
                    ...
                    <div className="container relative mx-auto px-4">
                        ...
                        <div className="grid md:grid-cols-4 gap-8 relative">
                            ...
                            {[
                                ...
                                { icon: Wrench, title: '2. Diagnóstico', desc: 'Avaliação técnica do ativo e envio de orçamento com fotos direto no seu celular.' },
